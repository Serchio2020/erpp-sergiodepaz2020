...
function Consultar() {
    $.ajax({
        ...
        $.each(response, function(index, data) {
            ...
            html += "<td>";
            html += "<button class='btn btn-warning mr-1' onclick='ConsultarPorId(" + data.idPersona + ");'><span class='fa fa-edit'></span></button>"
            html += "<button class='btn btn-danger' onclick='Eliminar(" + data.idPersona + ");'><span class='fa fa-trash'></span></button>"
            html += "</td>";
            html += "</tr>";
        });
